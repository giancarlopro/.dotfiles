...
vim.keymap.set('n', '<leader>gg', require('telescope.builtin').git_status, { desc = 'Search Git Status' })
...
-- Autoformatting with black on save for Python
vim.api.nvim_exec([[
  augroup Format
    autocmd!
...
vim.api.nvim_set_keymap('n', '<M-j>', ':m+<CR>==', { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '<M-j>', ':m\'>+<CR>gv=gv', { noremap = true, silent = true })
